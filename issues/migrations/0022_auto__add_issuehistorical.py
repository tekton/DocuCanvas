...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssueHistorical'
        db.create_table(u'issues_issuehistorical', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('meta_issues', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.MetaIssue'], null=True, blank=True)),
            ...
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assigned_to_history', null=True, to=orm['auth.User'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_by_history', null=True, to=orm['auth.User'])),
            ('point_of_contact', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='poc_history', null=True, to=orm['auth.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_by_history', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'issues', ['IssueHistorical'])


    def backwards(self, orm):
        # Deleting model 'IssueHistorical'
        db.delete_table(u'issues_issuehistorical')
