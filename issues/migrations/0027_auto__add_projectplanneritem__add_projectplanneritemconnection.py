...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectPlannerItem'
        db.create_table(u'issues_projectplanneritem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('item_type', self.gf('django.db.models.fields.CharField')(default='meta_issue', max_length=255, null=True, blank=True)),
            ('x_coordinate', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('y_coordinate', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'issues', ['ProjectPlannerItem'])

        # Adding model 'ProjectPlannerItemConnection'
        db.create_table(u'issues_projectplanneritemconnection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='source', to=orm['issues.ProjectPlannerItem'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target', to=orm['issues.ProjectPlannerItem'])),
        ))
        db.send_create_signal(u'issues', ['ProjectPlannerItemConnection'])


    def backwards(self, orm):
        # Deleting model 'ProjectPlannerItem'
        db.delete_table(u'issues_projectplanneritem')

        # Deleting model 'ProjectPlannerItemConnection'
        db.delete_table(u'issues_projectplanneritemconnection')
