...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdvancedSearchHash'
        db.create_table(u'issues_advancedsearchhash', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('search_hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ...
        db.send_create_signal(u'issues', ['AdvancedSearchHash'])

        # Adding model 'AdvancedSearch'
        db.create_table(u'issues_advancedsearch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True)),
            ('meta_issue', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True)),
            ('assigned_to', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True)),
            ...
            ('criticality', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fixability', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'issues', ['AdvancedSearch'])


    def backwards(self, orm):
        # Deleting model 'AdvancedSearchHash'
        db.delete_table(u'issues_advancedsearchhash')

        # Deleting model 'AdvancedSearch'
        db.delete_table(u'issues_advancedsearch')
    ...
    models = {
        ...
        u'issues.advancedsearch': {
            'Meta': {'object_name': 'AdvancedSearch'},
            'assigned_to': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'created_by': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'criticality': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'fixability': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'meta_issue': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'project': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
