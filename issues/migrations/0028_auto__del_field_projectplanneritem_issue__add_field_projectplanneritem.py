...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectPlannerItem.issue'
        db.delete_column(u'issues_projectplanneritem', 'issue_id')

        # Adding field 'ProjectPlannerItem.meta_issue'
        db.add_column(u'issues_projectplanneritem', 'meta_issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['issues.MetaIssue']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectPlannerItem.issue'
        db.add_column(u'issues_projectplanneritem', 'issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['issues.Issue']),
                      keep_default=False)

        # Deleting field 'ProjectPlannerItem.meta_issue'
        db.delete_column(u'issues_projectplanneritem', 'meta_issue_id')
