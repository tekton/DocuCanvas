...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.summary'
        db.alter_column('issues_issue', 'summary', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):

        # Changing field 'Issue.summary'
        db.alter_column('issues_issue', 'summary', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))
