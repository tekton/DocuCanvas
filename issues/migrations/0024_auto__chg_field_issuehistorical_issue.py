...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueHistorical.issue'
        db.alter_column(u'issues_issuehistorical', 'issue_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'], null=True))

    def backwards(self, orm):

        # Changing field 'IssueHistorical.issue'
        db.alter_column(u'issues_issuehistorical', 'issue_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['issues.Issue']))
