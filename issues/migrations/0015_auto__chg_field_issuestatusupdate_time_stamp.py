...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueStatusUpdate.time_stamp'
        db.alter_column(u'issues_issuestatusupdate', 'time_stamp', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'IssueStatusUpdate.time_stamp'
        db.alter_column(u'issues_issuestatusupdate', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
