...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.estimated_time'
        db.add_column(u'issues_issue', 'estimated_time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.estimated_time'
        db.delete_column(u'issues_issue', 'estimated_time')
