...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetaIssue'
        db.create_table(u'issues_metaissue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mi_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('user_story', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'issues', ['MetaIssue'])

        # Adding model 'Issue'
        db.create_table(u'issues_issue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('meta_issues', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.MetaIssue'])),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('projected_start', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('projected_end', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('actual_start', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('actual_end', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('view_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('issue_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('summary', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('link_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('criticality', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('fixability', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('r_and_d', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('feature', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('os', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('os_version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('browser', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('browser_version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('screen_shot', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('wireframe', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('uri_to_test', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'issues', ['Issue'])

        # Adding model 'IssueView'
        db.create_table(u'issues_issueview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('hash_val', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'issues', ['IssueView'])

        # Adding model 'IssueToIssue'
        db.create_table(u'issues_issuetoissue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('primary_issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='primary_issue', to=orm['issues.Issue'])),
            ('secondary_issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='secondary_issue', to=orm['issues.Issue'])),
            ('link_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'issues', ['IssueToIssue'])

        # Adding model 'SubscriptionToIssue'
        db.create_table(u'issues_subscriptiontoissue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('communication_type', self.gf('django.db.models.fields.CharField')(default='email', max_length=255)),
            ('communication_channel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'issues', ['SubscriptionToIssue'])


    def backwards(self, orm):
        # Deleting model 'MetaIssue'
        db.delete_table(u'issues_metaissue')

        # Deleting model 'Issue'
        db.delete_table(u'issues_issue')

        # Deleting model 'IssueView'
        db.delete_table(u'issues_issueview')

        # Deleting model 'IssueToIssue'
        db.delete_table(u'issues_issuetoissue')

        # Deleting model 'SubscriptionToIssue'
        db.delete_table(u'issues_subscriptiontoissue')
    ...
    models = {
        ...
        u'issues.issue': {
            ...
            'meta_issues': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['issues.MetaIssue']"}),
            ...
            'summary': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
