...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueFieldUpdate.old_value'
        db.alter_column(u'issues_issuefieldupdate', 'old_value', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'IssueFieldUpdate.new_value'
        db.alter_column(u'issues_issuefieldupdate', 'new_value', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'IssueFieldUpdate.old_value'
        db.alter_column(u'issues_issuefieldupdate', 'old_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'IssueFieldUpdate.new_value'
        db.alter_column(u'issues_issuefieldupdate', 'new_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
