...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'issues_issue', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Issue.modified'
        db.alter_column(u'issues_issue', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Issue.created'
        db.alter_column(u'issues_issue', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

        # Changing field 'Issue.modified'
        db.alter_column(u'issues_issue', 'modified', self.gf('django.db.models.fields.DateField')(auto_now=True))
