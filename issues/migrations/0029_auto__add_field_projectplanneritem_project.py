...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectPlannerItem.project'
        db.add_column(u'issues_projectplanneritem', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectPlannerItem.project'
        db.delete_column(u'issues_projectplanneritem', 'project_id')
