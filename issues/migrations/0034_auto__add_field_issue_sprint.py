...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.sprint'
        db.add_column(u'issues_issue', 'sprint',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sprints.Sprint'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.sprint'
        db.delete_column(u'issues_issue', 'sprint_id')
