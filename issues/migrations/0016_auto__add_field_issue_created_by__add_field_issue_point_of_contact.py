...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'issues_issue', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Issue.point_of_contact'
        db.add_column(u'issues_issue', 'point_of_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='poc', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.created_by'
        db.delete_column(u'issues_issue', 'created_by_id')

        # Deleting field 'Issue.point_of_contact'
        db.delete_column(u'issues_issue', 'point_of_contact_id')
