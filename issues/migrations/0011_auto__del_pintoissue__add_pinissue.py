...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PinToIssue'
        db.delete_table('issues_pintoissue')

        # Adding model 'PinIssue'
        db.create_table('issues_pinissue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('issues', ['PinIssue'])


    def backwards(self, orm):
        # Adding model 'PinToIssue'
        db.create_table('issues_pintoissue', (
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('issues', ['PinToIssue'])

        # Deleting model 'PinIssue'
        db.delete_table('issues_pinissue')
