...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IssueComment.text'
        db.delete_column('issues_issuecomment', 'text')

        # Adding field 'IssueComment.description'
        db.add_column('issues_issuecomment', 'description',
                      self.gf('django.db.models.fields.TextField')(default='no comment', max_length=255),
                      keep_default=False)


        # Changing field 'Issue.assigned_to'
        db.alter_column('issues_issue', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'IssueComment.text'
        raise RuntimeError("Cannot reverse this migration. 'IssueComment.text' and its values cannot be restored.")
        # Deleting field 'IssueComment.description'
        db.delete_column('issues_issuecomment', 'description')


        # User chose to not deal with backwards NULL issues for 'Issue.assigned_to'
        raise RuntimeError("Cannot reverse this migration. 'Issue.assigned_to' and its values cannot be restored.")
