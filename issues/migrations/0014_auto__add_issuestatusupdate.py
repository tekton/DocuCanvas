...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssueStatusUpdate'
        db.create_table(u'issues_issuestatusupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('old_status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('new_status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'issues', ['IssueStatusUpdate'])


    def backwards(self, orm):
        # Deleting model 'IssueStatusUpdate'
        db.delete_table(u'issues_issuestatusupdate')
