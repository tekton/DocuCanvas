...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'issues_issue', 'reported_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reported_by', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'issues.issue': {
            ...
            'reported_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reported_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
