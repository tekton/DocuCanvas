...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.meta_issues'
        db.alter_column(u'issues_issue', 'meta_issues_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.MetaIssue'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Issue.meta_issues'
        raise RuntimeError("Cannot reverse this migration. 'Issue.meta_issues' and its values cannot be restored.")
