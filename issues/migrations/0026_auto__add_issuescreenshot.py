...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssueScreenshot'
        db.create_table(u'issues_issuescreenshot', (
        ...
        db.send_create_signal(u'issues', ['IssueScreenshot'])


    def backwards(self, orm):
        # Deleting model 'IssueScreenshot'
        db.delete_table(u'issues_issuescreenshot')
