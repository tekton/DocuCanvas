...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'socialplatform_facebookprofile', ['user_id'])


        # Changing field 'FacebookProfile.user'
        db.alter_column(u'socialplatform_facebookprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'FacebookProfile.user'
        db.alter_column(u'socialplatform_facebookprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'FacebookProfile', fields ['user']
        db.create_unique(u'socialplatform_facebookprofile', ['user_id'])
