...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookProfile.issue'
        db.add_column(u'socialplatform_facebookprofile', 'issue',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookProfile.issue'
        db.delete_column(u'socialplatform_facebookprofile', 'issue')
