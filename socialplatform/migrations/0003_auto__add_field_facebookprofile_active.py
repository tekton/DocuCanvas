...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookProfile.active'
        db.add_column(u'socialplatform_facebookprofile', 'active',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookProfile.active'
        db.delete_column(u'socialplatform_facebookprofile', 'active')
