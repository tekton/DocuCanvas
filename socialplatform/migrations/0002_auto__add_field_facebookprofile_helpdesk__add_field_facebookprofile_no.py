...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookProfile.helpdesk'
        db.add_column(u'socialplatform_facebookprofile', 'helpdesk',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookProfile.notifications'
        db.add_column(u'socialplatform_facebookprofile', 'notifications',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookProfile.helpdesk'
        db.delete_column(u'socialplatform_facebookprofile', 'helpdesk')

        # Deleting field 'FacebookProfile.notifications'
        db.delete_column(u'socialplatform_facebookprofile', 'notifications')
