...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('checklists_checklistinstance', 'completion_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChecklistInstance.completion_status'
        db.delete_column('checklists_checklistinstance', 'completion_status')
    ...
    models = {
        ...
        'checklists.checklistlayoutitems': {
            'Checklist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['checklists.Checklist']"}),
            'Meta': {'object_name': 'CheckListLayoutItems'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
