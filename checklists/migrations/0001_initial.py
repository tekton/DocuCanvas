...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('checklists_checklist', (
            ...
            ('layout', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('checklists', ['Checklist'])

        # Adding model 'ChecklistInstance'
        db.create_table('checklists_checklistinstance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('checklist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checklists.Checklist'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('checklists', ['ChecklistInstance'])

        # Adding model 'ChecklistTag'
        db.create_table('checklists_checklisttag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('checklist_instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checklists.ChecklistInstance'])),
            ('completion_status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('checklists', ['ChecklistTag'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ChecklistInstance'
        db.delete_table('checklists_checklistinstance')

        # Deleting model 'ChecklistTag'
        db.delete_table('checklists_checklisttag')
    ...
    models = {
        ...
        'checklists.checklist': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layout': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"})
        },
        'checklists.checklistinstance': {
            'Meta': {'object_name': 'ChecklistInstance'},
            'checklist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['checklists.Checklist']"}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'checklists.checklisttag': {
            'Meta': {'object_name': 'ChecklistTag'},
            'checklist_instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['checklists.ChecklistInstance']"}),
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'completion_status': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
