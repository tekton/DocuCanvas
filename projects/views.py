...
def project_stats(request, project_id):
    try:
        ...
        #list of still active bugs sorted by criticality
    ...
    return render_to_response("projects/project_stats.html", {"bugs_for_review": bugs_for_review, "active_issues": active_issues, "not_a_bug_count": not_a_bug_count, "wont_fix_count": wont_fix_count, "duplicate_count": duplicate_count, "active_count": active_count, "fixed_count": fixed_count, "retest_count": retest_count, "unverified_count": unverified_count}, context_instance=RequestContext(request))
