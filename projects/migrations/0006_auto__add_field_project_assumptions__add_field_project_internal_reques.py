...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.assumptions'
        db.add_column(u'projects_project', 'assumptions',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.internal_requests'
        db.add_column(u'projects_project', 'internal_requests',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.assumptions'
        db.delete_column(u'projects_project', 'assumptions')

        # Deleting field 'Project.internal_requests'
        db.delete_column(u'projects_project', 'internal_requests')
