...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_project', 'repository_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.deployment_server'
        db.add_column('projects_project', 'deployment_server',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.deployment_url'
        db.add_column('projects_project', 'deployment_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('projects_project', 'repository_url')

        # Deleting field 'Project.deployment_server'
        db.delete_column('projects_project', 'deployment_server')

        # Deleting field 'Project.deployment_url'
        db.delete_column('projects_project', 'deployment_url')
