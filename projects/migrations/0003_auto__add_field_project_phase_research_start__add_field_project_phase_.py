...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.phase_research_start'
        db.add_column(u'projects_project', 'phase_research_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.phase_research_end'
        db.add_column(u'projects_project', 'phase_research_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.phase_research_start'
        db.delete_column(u'projects_project', 'phase_research_start')

        # Deleting field 'Project.phase_research_end'
        db.delete_column(u'projects_project', 'phase_research_end')
