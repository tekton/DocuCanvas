...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.assignable'
        db.add_column(u'accounts_account', 'assignable',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.assignable'
        db.delete_column(u'accounts_account', 'assignable')
