...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoogleAccount.account'
        db.alter_column(u'accounts_googleaccount', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True))

    def backwards(self, orm):

        # Changing field 'GoogleAccount.account'
        db.alter_column(u'accounts_googleaccount', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['accounts.Account']))
