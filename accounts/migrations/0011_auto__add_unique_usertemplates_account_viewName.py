...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserTemplates', fields ['account', 'viewName']
        db.create_unique(u'accounts_usertemplates', ['account_id', 'viewName'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserTemplates', fields ['account', 'viewName']
        db.delete_unique(u'accounts_usertemplates', ['account_id', 'viewName'])
    ...
    models = {
        ...
        u'accounts.usertemplates': {
            'Meta': {'unique_together': "(('account', 'viewName'),)", 'object_name': 'UserTemplates'},
