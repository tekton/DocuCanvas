...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_account', (
            ...
            ('avatar', self.gf('django.db.models.fields.CharField')(default='/static/img/pony.png', max_length=255, null=True, blank=True)),
            ('git_account', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('github_account', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
