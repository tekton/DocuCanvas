...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AccountSetting', fields ['user', 'setting_name']
        db.create_unique(u'accounts_accountsetting', ['user_id', 'setting_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'AccountSetting', fields ['user', 'setting_name']
        db.delete_unique(u'accounts_accountsetting', ['user_id', 'setting_name'])
    ...
    models = {
        ...
        u'accounts.accountsetting': {
            'Meta': {'unique_together': "(('user', 'setting_name'),)", 'object_name': 'AccountSetting'},
