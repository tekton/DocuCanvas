...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecordPermission.recordID'
        db.alter_column(u'accounts_recordpermission', 'recordID', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'RecordPermission.recordID'
        db.alter_column(u'accounts_recordpermission', 'recordID', self.gf('django.db.models.fields.IntegerField')())
