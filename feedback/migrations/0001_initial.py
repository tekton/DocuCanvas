...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SignedFeedback'
        db.create_table(u'feedback_signedfeedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'feedback', ['SignedFeedback'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SignedFeedback'
        db.delete_table(u'feedback_signedfeedback')
