...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserVoteItem'
        db.create_table(u'polls_uservoteitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.PollItem'])),
            ('voted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'polls', ['UserVoteItem'])


    def backwards(self, orm):
        # Deleting model 'UserVoteItem'
        db.delete_table(u'polls_uservoteitem')
    ...
    models = {
        ...
        u'polls.poll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_votes': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'total_items': ('django.db.models.fields.IntegerField', [], {'default': '2', 'null': 'True', 'blank': 'True'})
        },
        u'polls.pollitem': {
        ...
        u'polls.uservoteitem': {
            'Meta': {'object_name': 'UserVoteItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['polls.PollItem']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
