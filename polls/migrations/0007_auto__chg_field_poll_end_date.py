...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.end_date'
        db.alter_column(u'polls_poll', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 7, 18, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Poll.end_date'
        db.alter_column(u'polls_poll', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))
