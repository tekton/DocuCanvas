...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.total_items'
        db.alter_column(u'polls_poll', 'total_items', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Poll.total_items'
        db.alter_column(u'polls_poll', 'total_items', self.gf('django.db.models.fields.IntegerField')())
