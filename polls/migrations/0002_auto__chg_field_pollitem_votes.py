...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PollItem.votes'
        db.alter_column(u'polls_pollitem', 'votes', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PollItem.votes'
        db.alter_column(u'polls_pollitem', 'votes', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'polls.poll': {
            ...
            'total_items': ('django.db.models.fields.IntegerField', [], {'default': '2'})
        },
        u'polls.pollitem': {
