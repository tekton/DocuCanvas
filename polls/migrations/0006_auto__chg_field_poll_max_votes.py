...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.max_votes'
        db.alter_column(u'polls_poll', 'max_votes', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Poll.max_votes'
        db.alter_column(u'polls_poll', 'max_votes', self.gf('django.db.models.fields.IntegerField')(null=True))
