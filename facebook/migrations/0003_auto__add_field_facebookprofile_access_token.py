...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'facebook_facebookprofile', 'access_token',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'facebook_facebookprofile', 'access_token')
    ...
    models = {
        ...
        u'facebook.fbnotification': {
            'Meta': {'object_name': 'FBNotification'},
            'fb_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['facebook.FacebookProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
