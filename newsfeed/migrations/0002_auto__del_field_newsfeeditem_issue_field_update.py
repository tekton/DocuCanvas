...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsFeedItem.issue_field_update'
        db.delete_column(u'newsfeed_newsfeeditem', 'issue_field_update_id')


    def backwards(self, orm):
        # Adding field 'NewsFeedItem.issue_field_update'
        db.add_column(u'newsfeed_newsfeeditem', 'issue_field_update',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.IssueFieldUpdate'], null=True, blank=True),
                      keep_default=False)
