...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsFeedItem.timestamp'
        db.alter_column(u'newsfeed_newsfeeditem', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'NewsFeedItem.timestamp'
        db.alter_column(u'newsfeed_newsfeeditem', 'timestamp', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
