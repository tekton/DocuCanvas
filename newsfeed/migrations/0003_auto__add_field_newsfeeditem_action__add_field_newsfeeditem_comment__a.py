...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsFeedItem.action'
        db.add_column(u'newsfeed_newsfeeditem', 'action',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsFeedItem.comment'
        db.add_column(u'newsfeed_newsfeeditem', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsFeedItem.field_change'
        db.add_column(u'newsfeed_newsfeeditem', 'field_change',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsFeedItem.old_value'
        db.add_column(u'newsfeed_newsfeeditem', 'old_value',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsFeedItem.new_value'
        db.add_column(u'newsfeed_newsfeeditem', 'new_value',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsFeedItem.newsfeed_type'
        db.add_column(u'newsfeed_newsfeeditem', 'newsfeed_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsFeedItem.action'
        db.delete_column(u'newsfeed_newsfeeditem', 'action')

        # Deleting field 'NewsFeedItem.comment'
        db.delete_column(u'newsfeed_newsfeeditem', 'comment')

        # Deleting field 'NewsFeedItem.field_change'
        db.delete_column(u'newsfeed_newsfeeditem', 'field_change')

        # Deleting field 'NewsFeedItem.old_value'
        db.delete_column(u'newsfeed_newsfeeditem', 'old_value')

        # Deleting field 'NewsFeedItem.new_value'
        db.delete_column(u'newsfeed_newsfeeditem', 'new_value')

        # Deleting field 'NewsFeedItem.newsfeed_type'
        db.delete_column(u'newsfeed_newsfeeditem', 'newsfeed_type')
