...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsFeedItem.food'
        db.add_column(u'newsfeed_newsfeeditem', 'food',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.FoodRequest'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsFeedItem.checklist'
        db.add_column(u'newsfeed_newsfeeditem', 'checklist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checklists.Checklist'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsFeedItem.daily_report'
        db.add_column(u'newsfeed_newsfeeditem', 'daily_report',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['daily_reports.UserDailyReport'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsFeedItem.food'
        db.delete_column(u'newsfeed_newsfeeditem', 'food_id')

        # Deleting field 'NewsFeedItem.checklist'
        db.delete_column(u'newsfeed_newsfeeditem', 'checklist_id')

        # Deleting field 'NewsFeedItem.daily_report'
        db.delete_column(u'newsfeed_newsfeeditem', 'daily_report_id')
