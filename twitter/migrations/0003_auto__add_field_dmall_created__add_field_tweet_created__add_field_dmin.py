...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DMAll.created'
        db.add_column(u'twitter_dmall', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tweet.created'
        db.add_column(u'twitter_tweet', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DMIndividual.created'
        db.add_column(u'twitter_dmindividual', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DMAll.created'
        db.delete_column(u'twitter_dmall', 'created')

        # Deleting field 'Tweet.created'
        db.delete_column(u'twitter_tweet', 'created')

        # Deleting field 'DMIndividual.created'
        db.delete_column(u'twitter_dmindividual', 'created')
