...
TWITTER_TWITTER_CONSUMER_KEY		= os.getenv("TWITTER_TWITTER_CONSUMER_KEY")
TWITTER_CONSUMER_SECRET				= os.getenv("TWITTER_CONSUMER_SECRET")
TWITTER_TWITTER_ACCESS_KEY			= os.getenv("TWITTER_TWITTER_ACCESS_KEY")
TWITTER_TWITTER_ACCESS_SECRET		= os.getenv("TWITTER_TWITTER_ACCESS_SECRET")
