...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpRequest.edit_status_bool'
        db.add_column(u'helpdesknew_helprequest', 'edit_status_bool',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpRequest.edit_status_bool'
        db.delete_column(u'helpdesknew_helprequest', 'edit_status_bool')
